...
<ul class="breadcrumb">
                ...
                <li><a href="Inscription_admin.php">S'inscrire</a></li>
            </ul>
            <br><br>
            <section>
                <form name="myForm" method="post" onsubmit="return validateForm()">
                    ...
                    <div id="bas_form"> 
                            ...
                            <input type="submit" name="formsend3" id="formsend3" value="Envoyer le formulaire" style="font-size: 11pt" />
                    </div>
                    <?php include'signin_admin.php'?>
                </form>
