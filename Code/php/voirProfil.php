	...
	if (isset($_FILES['avatar']) AND !empty($_FILES['avatar']['name'])) 
		...
		if ($_FILES['avatar']['size'] <= $taillemax) 
		{
			$extensionUpload = strtolower(substr(strrchr($_FILES['avatar']['name'], '.'),1));
				...
				{
					$chemin = "../img/membres/avatars/".$_GET['id'].".".$extensionUpload;
		...
		<div id="bloc_page">
			...
			<ul class="breadcrumb">
 				<li><a href="Accueil.php">Accueil</a></li>
  				...
  				<li><a href="voirProfil.php">Consulter profil utilisateur</a></li>
			</ul>
<br><br>
		...
		$requeteInfo = $db->prepare('SELECT Nom,Prenom,Email,Telephone,idUtilisateur,Sexe,Adresse,avatar FROM utilisateur WHERE idUtilisateur= :idUtilisateur');
		$requeteInfo->execute(['idUtilisateur' => $_GET['id']]);
					...
					<div id="container" >
		            	...
		            	<div id="info_form">
			            	<div id="info_personnel">
			            		<h1 class="phrase">Voici les informations personnelles du compte</h1>
			            		<hr>

		            		
	            				<div id="photo_profil">
	            				<img src="../img/membres/avatars/<?php echo $informations['avatar'];?>" width="150" height="150">
	            			...
	            			<table id="recapitulatif_info">
	            					<tr>
						    			...
						    			<td class="indentifiant"> <?php echo "  ".$informations['idUtilisateur']; ?></td>
						    		</tr>
						    		<tr> <td><br></td></tr>
						    		<tr>
...
if ($execution==false) 
	{ ?>
		...
		<td class="indentifiant">Le compte n'est pas encore membre d'une équipe</td>
<?php
}
else{

	?>					    			<td class="indentifiant">Equipe Esport :</td>
						    			<td class="indentifiant"> <?php echo "  ". $execution['nomEquipe']; ?></td>
						    		</tr>
<?php }?>
						    	</table>
