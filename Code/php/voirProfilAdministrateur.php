	...
	if (isset($_FILES['avatar']) AND !empty($_FILES['avatar']['name'])) 
		...
		if ($_FILES['avatar']['size'] <= $taillemax) 
		{
			$extensionUpload = strtolower(substr(strrchr($_FILES['avatar']['name'], '.'),1));
				...
				{
					$chemin = "../img/membres/avatars_admin/".$_GET['id'].".".$extensionUpload;
		...
		<div id="bloc_page">
			...
			<ul class="breadcrumb">
 				<li><a href="Accueil.php">Accueil</a></li>
  				...
  				<li><a href="voirProfilAdministrateur.php">Consulter profil administrateur</a></li>
			</ul>
<br><br>
		...
		$requeteInfo = $db->prepare('SELECT Nom,Prenom,Email,Telephone,idAdministrateur,Sexe,avatar,Adresse FROM administrateur WHERE idAdministrateur= :idAdministrateur');
		$requeteInfo->execute(['idAdministrateur' => $_GET['id']]);
					...
					<div id="container" >
		            	...
		            	<div id="info_form">
			            	<div id="info_personnel">
	            				...
	            				<div id="photo_profil">
	            				<img src="../img/membres/avatars_admin/<?php echo $informations['avatar'];?>" width="150" height="150">
	            			...
	            			<table id="recapitulatif_info">
	            					<tr>
						    			...
						    			<td class="indentifiant"> <?php echo "  ".$informations['idAdministrateur']; ?></td>
						    		</tr>
						    		<tr> <td><br></td></tr>
						    		<tr>
